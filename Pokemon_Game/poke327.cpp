...
int main(int argc, char *argv[])
{
  ...
  //return(0); // use this when testing db_parse. (if segmentation faulting is occuring, it could be caused by db_parse if it gets updated)
